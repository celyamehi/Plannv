            ...
            <div className="w-full max-w-4xl">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <Link href="/login" className="block h-full">
                        <Card className="h-full hover:shadow-lg transition-all duration-300 cursor-pointer border-2 hover:border-purple-600 group">
                            <CardHeader className="text-center">
                                ...
                                <CardTitle className="text-2xl group-hover:text-purple-600 transition-colors">Espace Client</CardTitle>
                    ...
                    <Link href="/professionals/login" className="block h-full">
                        <Card className="h-full hover:shadow-lg transition-all duration-300 cursor-pointer border-2 hover:border-pink-600 group">
                            <CardHeader className="text-center">
                                ...
                                <CardTitle className="text-2xl group-hover:text-pink-600 transition-colors">Espace Professionnel</CardTitle>
                                <CardDescription className="text-base">
